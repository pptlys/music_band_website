...
function filterSearch() {
    ...
    if (!(
        ...
        (seriesFilterIndex === 0 && seasonFilterIndex != 0 && monthFilterIndex === 0) ||
        (seriesFilterIndex === 0 && seasonFilterIndex === 0 && monthFilterIndex != 0))) {
        alert("Please select only one (1) search filter");
    ...
    //if filtering by season
        ...
        //Fall or Winter (no concerts available for now)
            ...
            upcomingEventsText.innerText = "Stay tuned for updates on our upcoming events!";
        }
    }
...
function lang_toggle(){
    ...
    if (current_lang === 'en') {
        ...
        window.open("..pages/events.html", "_self")
    }
}